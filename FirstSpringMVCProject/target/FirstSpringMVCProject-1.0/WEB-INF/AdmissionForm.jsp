<%-- 
    ...
    Created on : 2015-06-28, 00:12:01
    Author     : Olaa
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
<!--potrzebne do form:errors-->
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Admission Form JSP Page</title>
    </head>
    <body>
        <h1>${headerMessage}</h1>
        <h3>STUDENT ADMISSION FORM FOR ENGINEERING COURSES</h3>

        <form:errors path="student.*"/><!--jezeli beda jakies errory, to je pokaze(z nowa strona)-errory oczywiscie dla studenta-->
